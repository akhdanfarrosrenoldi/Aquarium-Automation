...
String apiKey = "P1HMQ0FG59HZB4QU";     //  Enter your Write API key from ThingSpeak
 
const char *ssid =  "HUAWEI-j6V4";     // replace with your wifi ssid and wpa2 key
const char *pass =  "maret377";
