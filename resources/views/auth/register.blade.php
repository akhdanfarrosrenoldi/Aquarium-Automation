...
@section('content')
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('https://img.freepik.com/premium-photo/aquarium-colorful-underwater-world-with-fish-plants-banner-with-copy-space-made-with-generative-ai_155027-3451.jpg?w=1380'); background-position: top;">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                        <p class="text-lead text-white">Aquarium automation refers to the use of technology and automated systems to control and monitor various aspects of an aquarium environment</p>
                    </div>
                </div>
            </div>
        </div>
